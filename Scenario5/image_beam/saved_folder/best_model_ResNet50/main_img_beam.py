...
def main():
    ...
    shutil.copy('./scenario5_img_beam_train.csv', pwd)
    shutil.copy('./scenario5_img_beam_val.csv', pwd)
    shutil.copy('./scenario5_img_beam_test.csv', pwd)
    ...
    train_dir = 'scenario5_img_beam_train.csv'
    val_dir = 'scenario5_img_beam_val.csv'
    ...
    test_dir = './scenario5_img_beam_test.csv'
