...
def main():
    ...
    shutil.copy('./scenario6_img_pos_beam_train.csv', pwd)
    shutil.copy('./scenario6_img_pos_beam_val.csv', pwd)
    shutil.copy('./scenario6_img_pos_beam_test.csv', pwd)
    ...
    train_dir = 'scenario6_img_pos_beam_train.csv'
    val_dir = 'scenario6_img_pos_beam_val.csv'
    ...
    test_dir = './scenario6_img_pos_beam_test.csv'
